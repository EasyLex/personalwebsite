...
class halamanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate(
            [
                ...
                'isi.required'=>'Please fill out this field.',
            ]
        );
        ...
        return redirect()->route('halaman.index')->with('success', 'Page added');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Page Updated');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('halaman.index')->with('success', 'Page Deleted');
    }
}
