...
<html lang="en">
    <head>
        ...
        <title>Alexander Nathaniel Anggiono</title>
        <link rel="shortcut icon" href="{{asset('admin')}}/images/easylex_logo.png" />
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="sideNav">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="/auth/redirect">Settings</a></li>
                </ul>
            </div>
        </nav>
        <!-- Page Content-->
